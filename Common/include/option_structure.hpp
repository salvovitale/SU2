...
enum TURBOMACHINERY_TYPE {
  ...
  CURVED_CHANNEL_ZX = 6,      /*!< \brief curved channel from z to x. */
  CHANNEL = 7,                    /*!< \brief straight channel parallel to z axis. */
  CHANNEL_X = 8                  /*!< \brief straight channel parallel to x axis. */
};
